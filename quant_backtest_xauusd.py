...
def run_quant_backtest():
    file_path = "data/xauusd-m5-bid-2021-03-01-2026-03-15.csv"
    print(f"Loading actual XAUUSD 5m data from {file_path}...")
    ...
    # Format to uniform column names
    ...
    print("Simulating trades with session (13-17 UTC) and Mon-Thu filters on real XAUUSD...")
    ...
    if not trades_df.empty:
        ...
        trades_df.to_csv('xauusd_filtered_trades.csv', index=False)
